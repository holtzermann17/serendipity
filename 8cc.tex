...
which helps to show that our definition is not overly inclusive.  The
second example outlines a ``grand challenge''.  The third example is
also prospective, and combines design with prototyping.  As Campbell
...
improvisations are most valuable.  \citeA{jordanous10} notes that this
