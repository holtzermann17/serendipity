...
The structure of this section follows and updates an earlier survey
from \citeA{pease2013discussion}.
...
\item \textbf{Focus shift}: George de Mestral, an electrical engineer
  ...
  fashion, laying the foundations for the hook-and-loop fastener.
% \cite[p. x]{roberts}
\end{itemize}
