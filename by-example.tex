...
For this paper, we adapt the computational
concepts related to serendipity proposed by \citeA{pease2013discussion}. This
section will briefly introduce these concepts, and illustrate them
by means of historical examples of serendipity.
...
\item \textbf{Focus shift}: George de Mestral, an electrical engineer
  ...
  fashion, laying the foundations for the hook-and-pile fastener.
% \cite[p. x]{roberts}
\end{itemize}
...
\item \textbf{Result}: This may be a new product, artefact, process,
  ...
  be a {\em new} hypothesis or problem.  The result may be
...
We will outline how the key condition, the components, dimensions and environmental factors can be assessed and modeled computationally in Sec. \ref{sec:computational-serendipity}.
