...
\item \textbf{Curiosity}: Curiosity can dispose a creative person to
  ...
  own life experience: ``from the time his attention was first given
...
\item \textbf{Value}: 
  ...
  treasure.''  One example that takes this literally is the Swiss
...
\item \textbf{Dynamic world}: Information about the world develops
  ...
  revealing to consider a \emph{counterexample}, in which dynamics are
