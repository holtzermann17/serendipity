...
\item \textbf{Value}: Note that the chance ``discovery'' of, say, a
  ...
  man's treasure.''  One example is the Swiss company Freitag, which
  has built a business around ``upcycling'' used truck tarps into bags
  and backpacks.  If possible we prefer an independent judgement of
  value \cite{jordanous:12}.
\end{itemize}
...
and assessed in computational systems in Section
