...
measured.   The following section surveys the relevant criteria.
...
As well as considering \emph{instances} of serendipity, we speak of a system's \emph{potential} for serendipity.
...
in the process that preparation can support, but that it does not always fully
...
Writers Workshops, to open source software, to community-based approaches in
psychological counselling have been developed to exploit similar emergent effects and to develop
