...
From this analysis, we extract recommendations for practitioners working with computational serendipity, and outline future directions for research.  We argue that patterns of serendipity can be used in the design of computational systems, that there is much to be gained by building an awareness of serendipity into these systems, and that serendipity is particularly critical for autonomous systems.
\\[.3cm]
