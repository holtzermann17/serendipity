...
%
We develop case studies that evaluate the serendipity of existing systems, and develop a thought experiment that applies our model to a design for multi-agent environment for computer poetry.
%
