...
%
We develop case studies that evaluate the serendipity of existing systems, and a thought experiment that applies our model in a design for multi-agent environment for computer poetry.
%
