...
formalising this concept.  This paper follows and expands \citeA{pease2013discussion}, where many of the ideas that are developed here were first presented.  The current paper uses the opportunity of working with a broader canvas to advance some bold claims about the usefulness of serendipity as a framework for computational creativity.
