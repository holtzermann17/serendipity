...
The constituent terms in this definition are purposefully general: it
is their relationship that matters.  A trigger, for example, is not
defined in terms of a specific data structure, nor is a bridge
constrained to be a specific set of reasoning techniques.  We view
such generality as a strength, but it does leave further work for
anyone who aims to apply the definition in practice.  The Section
\ref{specs-overview} presents further structure that makes this work
more routine.
