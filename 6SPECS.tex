...
encounter with burrs.  The probability of encountering burrs while out
...
sagacity (and tenacity) to turn what he discovered into a successful
product.  The details of the particular burrs that were encountered
effectively irrelevant.  The trigger itself may be a complex object or
event that takes place over a period of time; in other words, it may
be a pattern, rather than a fact.  Noticing that a pattern exists is a
key aspect of sagacity.
