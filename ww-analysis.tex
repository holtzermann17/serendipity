...
(after a more predictable training course, say, reading the English
language poetry canon), most poems consumed by the system would never
have been seen before, and the chance of observing a given serendipity
trigger would be very small.  While the likelihood of detecting an
already-known poetic feature in a given poem where it is present is
presumably fairly high, we are particularly interested in the cases of
where a novel and interesting poetic feature can be found and attended
to, and this would remain an infrequent occurrence (on a population
basis, among {\tt listening} subsystems), at least until the system as
a whole became very good at reading poems.  Indeed, a sophisticated
...
be shown in practice.  New poetic ideas would presumably be seen as
high-value at first, although only some of the ideas will prove to be
of lasting value.  Our likelihood score would be
...
Influences could be highly multiple, including many very different kinds of poems
