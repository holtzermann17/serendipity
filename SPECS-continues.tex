...
\noindent In Section \ref{sec:computational-serendipity} we pilot our framework by examining the degree of serendipity of existing computational systems, looking for ways that they could become more serendipitous enhanced.  We will also use the framework to guide the high-level design of a novel system. 
