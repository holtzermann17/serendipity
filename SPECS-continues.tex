...
With our definition in mind, we propose the following standards for evaluating our definition of serendipity:
...
\emph{($\mathbf{c}$ - \textbf{sagacity})} On a population basis, comparing
  similar circumstances, how likely was it that a similar trigger
